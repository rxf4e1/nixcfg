...
static const char *menucma[] = { "bemenu-run", NULL };
static const char *emaxcmd[] = { "emw", NULL };
...
static const char *mutevol[] =   { "wpctl", "set-volume", "@DEFAULT_AUDIO_SINK@", "toggle", NULL };
...
static const Key keys[] = {
  ...
  { MODKEY,                    XKB_KEY_d,          spawn,          {.v = menucma} },
  { MODKEY|SHIFT,              XKB_KEY_Return,     spawn,          {.v = termcmd} },
  { MODKEY,                    XKB_KEY_5,          spawn,          {.v = emaxcmd} },
  { MODKEY,                    XKB_KEY_6,          spawn,          {.v = firefox} },
  ...
  { MODKEY|SHIFT,              XKB_KEY_Q,          killclient,     {0} },
