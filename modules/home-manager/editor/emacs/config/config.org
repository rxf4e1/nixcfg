...
;; GSH_THEME (https://codeberg.org/Tav/gsh_theme/src/branch/main/emacs)
;; (add-to-list 'custom-theme-load-path "~/.config/emacs/.local/etc/themes")
;; (load-theme 'gsh t nil)
#+end_src
...
(with-eval-after-load 'mono-complete
  (keymap-set mono-complete-mode-map "<tab>" #'mono-complete-expand-or-fallback))
#+end_src
